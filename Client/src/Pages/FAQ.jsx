...
import React, { useState } from 'react';
 ...
 const faqData = {
   ...
   Payment: [
 {
   question: 'What payment methods are accepted?',answer: 'Most auction platforms accept multiple payment methods including credit and debit cards, PayPal, bank transfers, and sometimes digital wallets. Check the platform’s payment policy before bidding to avoid any issues after winning.'},    { question: 'Are payments refundable?', answer: 'Most auction sales are final unless stated otherwise in the policy.' },
 ...
 const FAQ = () => {
    ...
    <div className="px-4 md:px-20 py-12 w-full">
      ...
      >
         ...
         <Tabs
          ...
          sx={{
           borderBottomLeftRadius: 8, // theme spacing (e.g., 8px if default spacing = 1)
  ...
  <div className="flex flex-col md:flex-row w-full justify-between px-4 md:px-20 gap-5">
  {/* Card 1 */}
  <div className="relative w-full md:w-[900px] h-32 rounded-lg overflow-hidden">
    <img

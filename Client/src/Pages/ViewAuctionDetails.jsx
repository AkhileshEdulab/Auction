...
>
  ...
  <div className="flex items-center gap-4 w-1/3">
    ...
    />
    <span className="text-base font-medium text-gray-800">{bidder?.userName}</span>
  </div>

  {/* Bid Amount */}
  <div className="w-1/3 text-center">
    <span className="font-semibold text-gray-700">₹.{bidder?.amount}</span>
  </div>

  {/* Position (1st, 2nd, etc.) */}
  <div className="w-1/3 text-end pr-2">
    <span

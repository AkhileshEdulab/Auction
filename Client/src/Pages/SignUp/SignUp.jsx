          ...
          {/* {role === 'Auctioneer' && (
            ...
            <div className='flex flex-col gap-4 transition-all duration-700'>
              ...
              <FormControl  color="error" fullWidth>
                ...
                <Select value={bankName} onChange={(e) => setBankName(e.target.value)} label="Bank Name" disabled={role ==='Bidder'}>
...
<div
  className={`overflow-hidden transition-all ease-in-out duration-1000 ${
    role === 'Auctioneer' ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'
  }`}
>

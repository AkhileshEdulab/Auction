...
export const getAllAuction = () =>async (dispatch) =>{
    ...
    try {
        const response = await axios.get("https://auction-7ovg.onrender.com/api/v1/auction/getAll",{withCredentials:true})
...
export const getAuctionDetails = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`https://auction-7ovg.onrender.com/api/v1/auction/item/${id}`, {
...
export const createAuction = (data) => async (dispatch) => {
  ...
  try {
    ...
    const response = await axios.post(
      'https://auction-7ovg.onrender.com/api/v1/auction/create',
      data,
      {
        withCredentials: true,
        headers: {
...
export const getMyAuction = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`https://auction-7ovg.onrender.com/api/v1/auction/myitems`, {
      withCredentials: true
    });
...
export const republishAuctionItems =(id,data)=>async(dispatch)=>{
  ...
  try {
    const response = await axios.put(`https://auction-7ovg.onrender.com/api/v1/auction/republish/item/${id}`,data,
...
export const deleteAuctionItems =(id)=>async(dispatch)=>{
  ...
  try {
    const response = await axios.delete(`https://auction-7ovg.onrender.com/api/v1/auction/item/delete/${id}`,
      {withCredentials:true,});

...
export const register = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      'https://auction-7ovg.onrender.com/api/v1/user/register',
      data,
      {
...
export const login = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      'https://auction-7ovg.onrender.com/api/v1/user/login',
      data,
      {
        withCredentials: true,
        headers: {
...
export const logout = () => async (dispatch) => {
  try {
    const response = await axios.get(
      "https://auction-7ovg.onrender.com/api/v1/user/logout",
      {
        withCredentials: true, 
      }
    );
...
export const fetchUser = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get('https://auction-7ovg.onrender.com/api/v1/user/me', {
      withCredentials: true,
    });
...
export const featchLeaderboard = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get('https://auction-7ovg.onrender.com/api/v1/user/leaderboard', {
      withCredentials: true,
    });

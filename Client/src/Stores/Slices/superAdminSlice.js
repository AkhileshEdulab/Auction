...
export const fetchAllUser = (id)=>async(dispatch)=>{
    ...
    try {
        const response = await axios.get('http://localhost:5000/api/v1/superAdmin/user/getAll',
            {withCredentials:true})
...
export const deletePaymentProof = (id)=>async(dispatch)=>{
    ...
    try {
        const response = await axios.delete(`http://localhost:5000/api/v1/superAdmin/paymentProof/delete/${id}`)
...
export const getAllPaymentProof = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get("http://localhost:5000/api/v1/superAdmin/paymentProof/getAll", {
            withCredentials: true
        });

...
export const monthlyRevenue = ()=>async(dispatch)=>{
    ...
    try {
        const response =await axios.get('https://auction-7ovg.onrender.com/api/v1/superAdmin/monthlyincome',
...
export const fetchAllUser = (id)=>async(dispatch)=>{
    ...
    try {
        const response = await axios.get('https://auction-7ovg.onrender.com/api/v1/superAdmin/user/getAll',
            {withCredentials:true})
...
export const deletePaymentProof = (id)=>async(dispatch)=>{
    ...
    try {
        const response = await axios.delete(`https://auction-7ovg.onrender.com/api/v1/superAdmin/paymentProof/delete/${id}`)
...
export const getSinglePaymentProof = (id)=>async(dispatch)=>{
    ...
    try {
        const response = await axios.get(`https://auction-7ovg.onrender.com/api/v1/superAdmin/paymentProof/${id}`,
        )
...
export const getAllPaymentProof = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get("https://auction-7ovg.onrender.com/api/v1/superAdmin/paymentProof/getAll", {
            withCredentials: true
        });
...
export const updatePaymentProof = (id, status , amount) => async (dispatch) => {
    ...
    try {
        const response = await axios.put(
            `https://auction-7ovg.onrender.com/api/v1/superAdmin/paymentProof/status/update/${id}`,
            {status , amount},
            {
...
export const deleteAuction = (id) => async (dispatch) => {
    ...
    try {
        const response = await axios.delete(
            `https://auction-7ovg.onrender.com/api/v1/superAdmin/auctionItem/delete/${id}`,
            { withCredentials: true }
        );
